...
def clean_data(data):
    ...
    try:
        ...
        df_cleaned["Treatments_Tokenized"] = df_cleaned["Treatments"].apply(
            simple_tokenize
        )
        ...
        print(
            f"Error: A required column was not found. Please check your DataFrame for column: {e}"
        )
        return None
...
if __name__ == "__main__":
    try:
        ...
        raw_data = pd.read_csv(
            r"C:\Users\USER\Documents\AI_Clinical_Assistant\data\Diseases_Symptoms.csv"
        )
        ...
        if cleaned_df is not None:
            ...
            cleaned_df.to_csv(
                r"C:\Users\USER\Documents\AI_Clinical_Assistant\data\clean_data",
                index=False,
            )
